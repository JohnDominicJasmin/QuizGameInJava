 ...
 * @author micojasmin
 */
class lifebar2 extends lifebar{
   
}
 public class Gaming2 extends javax.swing.JFrame{
 lifebar lf2 = new lifebar();
    ...
    private void initComponents() {
        ...
        jbttnHTML.setText("B. The Last of Us");
        ...
        jTextArea1.setText("What is the best-selling video game of all time?");
        ...
        jbttnMinecraft.setText("C. Minecraft");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gaming2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
