...
class lifebar{
 ...
 public class Gaming1 extends javax.swing.JFrame{
 lifebar lf  = new lifebar();
    ...
    private void initComponents() {
        ...
        jbttnHTML.setText("B. Donkey Kong Country");
        ...
        jTextArea1.setText("What was the first commercially successful video\n game?");
        ...
        jbttnCPROGRAMMING.setText("C. Shaq Fu");
        ...
        jbttnMYSQL.setText("D. Super Mario Bros");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gaming1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
