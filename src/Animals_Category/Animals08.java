 ...
 * @author micojasmin
 */
class Anims8 extends Anims7{
    
}
public class Animals08 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbttnAfrica = new javax.swing.JRadioButton();
        ...
        jTextArea1.setText("On what continent can you find wild gorillas, \nchimpanzees and honobos?");
        ...
        jbttnEggshell.setText("C. Australia");
        ...
        jbttnAfrica.setFont(new java.awt.Font("sansserif", 0, 15)); // NOI18N
        jbttnAfrica.setText("B. Africa");
        jbttnAfrica.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jbttnAfrica.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbttnAfricaActionPerformed(evt);
            }
        });
        jPanel1.add(jbttnAfrica);
        jbttnAfrica.setBounds(250, 130, 200, 40);

        jbttnMonth.setFont(new java.awt.Font("sansserif", 0, 15)); // NOI18N
        jbttnMonth.setText("D. North America");
    ...
    private void jbttnAfricaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttnAfricaActionPerformed
        if (jbttnAfrica.isSelected()) {
            jButtonCheck.setVisible(true);
            jbttnWaterland.setEnabled(false);
            jbttnEggshell.setEnabled(false);
            jbttnMonth.setEnabled(false);

        } else if (!jbttnAfrica.isSelected()) {
            jButtonCheck.setVisible(false);
            jbttnWaterland.setEnabled(true);
            jbttnMonth.setEnabled(true);
            jbttnEggshell.setEnabled(true);
        }
    }//GEN-LAST:event_jbttnAfricaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animals08.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JRadioButton jbttnAfrica;
