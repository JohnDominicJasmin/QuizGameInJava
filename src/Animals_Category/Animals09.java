 ...
 * @author micojasmin
 */
class Anims9 extends Anims8{
    
}
public class Animals09 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("A captive gorilla named Koko was able to communicate\nwith human using what?");
        ...
        jbttnEggshell.setText("C. speech");
        ...
        jbttnSingLang.setText("B. sign language");
        ...
        jbttnWaterland.setText("A. chalk and blackboard");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animals09.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
